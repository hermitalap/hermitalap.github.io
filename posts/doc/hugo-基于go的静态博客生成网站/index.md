...
[主题文档 - 基本概念 - DoIt](https://hugodoit.pages.dev/zh-cn/theme-documentation-basics/)
...
或者可以在`/assets`或`/static`目录下放置图片文件, 并配置`avatarURL`下的地址来显示头像.引用资源的文件路径是相对于`assets`或`static`目录的.
